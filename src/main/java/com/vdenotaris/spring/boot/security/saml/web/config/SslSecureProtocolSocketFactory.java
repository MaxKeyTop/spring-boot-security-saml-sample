...
public class SslSecureProtocolSocketFactory  implements SecureProtocolSocketFactory {
     ...
     */
    public SslSecureProtocolSocketFactory() {
    }
    /**
    ...
    private static SSLContext createEasySSLContext() {
        try {
            ...
            context.init(null, new TrustManager[] { new SslX509TrustManager() },
                    null);
            return context;
        } catch (Exception e) {
